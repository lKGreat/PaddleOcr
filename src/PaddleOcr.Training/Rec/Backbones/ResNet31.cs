...
/// <summary>
/// ResNet31 backbone：用于 SAR、SATRN 等 attention 系列模型。
/// </summary>
public sealed class ResNet31 : Module<Tensor, Tensor>, IRecBackbone
{
    private readonly Module<Tensor, Tensor> _features;
    public int OutChannels { get; }

    public ResNet31(int inChannels = 3, int[] layers = null!) : base(nameof(ResNet31))
    {
        layers ??= [1, 2, 5, 3];
