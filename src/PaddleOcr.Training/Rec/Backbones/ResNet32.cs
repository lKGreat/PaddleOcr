...
/// <summary>
/// ResNet32 backbone：用于 NRTR 等模型。
/// </summary>
public sealed class ResNet32 : Module<Tensor, Tensor>, IRecBackbone
{
    private readonly Module<Tensor, Tensor> _features;
    public int OutChannels { get; }

    public ResNet32(int inChannels = 3, int[]? layers = null) : base(nameof(ResNet32))
    {
        layers ??= [1, 2, 5, 3];
